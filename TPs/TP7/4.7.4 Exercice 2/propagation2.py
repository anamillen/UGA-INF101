...
def lancage_aleatoire(a, b, N):
    """Lance successivement N exécutions
    avec différentes valeurs de n dans l'intervalle [a,b]"""
    for _ in range(N):
...
a = 100
b = 1000
N = 20 # numero de lancages
lancage_aleatoire(a,b,N)